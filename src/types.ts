import imgCauliflowerPumpkin from '../src/assets/menu/chicken-cauliflower-pumpkin.webp';
import imgBowlChapti from '../src/assets/menu/chicken-egg-bowl-chapti.webp';
import imgChickenSalad from '../src/assets/menu/chicken-salad.webp';
import imgEggSundal from '../src/assets/menu/egg-sundal-bowl.webp';
import imgGarlicPasta from '../src/assets/menu/garlic-chicken-pasta.webp';
import imgLemonChicken from '../src/assets/menu/lemon-chicken-egg-masala.webp';
import imgMasalaThokku from '../src/assets/menu/masala-chicken-egg-thokku.webp';
import imgTomatoChicken from '../src/assets/menu/tomato-chicken.webp';
import imgBeetrootMasala from '../src/assets/menu/beetroot-masala-chicken.webp';
import imgBoiledEggGroundnuts from '../src/assets/menu/boiled-egg-groundnuts.webp';
import imgBoiledEggHorsegram from '../src/assets/menu/boiled-egg-horse-gram.webp';
import imgCarrotRicePumpkin from '../src/assets/menu/carrot-rice-chicken-with-pumpkin.webp';
import imgCauliflowerChicken from '../src/assets/menu/cauliflower-chicken.webp';
import imgChickenSaladSweetpotato from '../src/assets/menu/chicken-salad-sweetpotato.webp';
import imgEggChickenSalad from '../src/assets/menu/egg-chicken-salad.webp';
import imgEggSaladSweetpotato from '../src/assets/menu/egg-salad-sweetpotato.webp';
import imgHorsegramBeetroot from '../src/assets/menu/horsegram-chicken-beetroot-salad.webp';
import imgMasalaSaladPasta from '../src/assets/menu/masala-chicken-salad-pasta.webp';
import imgMasalaSweetpotato from '../src/assets/menu/masala-chicken-sweetpotato.webp';
import imgSaladPasta from '../src/assets/menu/salad-chicken-pasta.webp';
import imgSundalPepperRice from '../src/assets/menu/sundal-rice-pepper-chicken.webp';
import imgSundalSalad from '../src/assets/menu/sundal-salad-chicken.webp';
